...
# Base height
UPPER_BASE_HEIGHT = np.asarray([np.inf, np.inf, 0.35])
LOWER_BASE_HEIGHT = np.asarray([-np.inf, -np.inf, 0.2])

# Base height for robust controller
UPPER_BASE_HEIGHT_ROBUST = np.asarray([np.inf, np.inf, 0.5])
LOWER_BASE_HEIGHT_ROBUST = np.asarray([-np.inf, -np.inf, 0.0])

# Base reference velocity
UPPER_REF_SPEED = np.array([5.0, 5.0])
LOWER_REF_SPEED = np.array([-5.0, -5.0])

# Base linear velocity for robust controller
UPPER_BASE_LINEAR_VELOCITY_ROBUST = np.array([5, 5, 5])
LOWER_BASE_LINEAR_VELOCITY_ROBUST = np.array([-5, -5, -5])

# Base linear velocity
UPPER_BASE_LINEAR_VELOCITY = np.array([5, 1, 5])
LOWER_BASE_LINEAR_VELOCITY = np.array([-5, -1, -5])

# Base angular velocity
UPPER_BASE_ANGULAR_VELOCITY = np.array([2, 2, 1])
LOWER_BASE_ANGULAR_VELOCITY = np.array([-2, -2, -1])

# Feet linear velocities
UPPER_FEET_LINEAR_VELOCITY =np.array([5, 1, 5,
                                5, 1, 5,
                                5, 1, 5,
                                5,1,5])
LOWER_FEET_LINEAR_VELOCITY =np.array([-5, -1, -5,
                                -5, -1, -5,
                                -5, -1, -5,
                                -5, -1, -5])

# Feet position
UPPER_FEET_POSITION = np.array([0,-0.0075, -0.1,
                                0,0.16,-0.1,
                                0,-0.0075,-0.1,
                                0,0.16,-0.1])

LOWER_FEET_POSITION = np.array([-0.37,-0.16, -0.3,
                                -0.37,0.0075,-0.3,
                                -0.37,-0.16,-0.3,
                                -0.37,0.0075,-0.3])

# Feet position for robust controller
UPPER_FEET_POSITION_ROBUST = np.array([0,-0.0075, -0.1,
                                0,0.16,-0.1,
                                0,-0.0075,-0.1,
                                0,0.16,-0.1])

LOWER_FEET_POSITION_ROBUST = np.array([-0.37,-0.16, -0.5,
                                -0.37,0.0075,-0.5,
                                -0.37,-0.16,-0.5,
                                -0.37,0.0075,-0.5])

# Contact bool
UPPER_CONTACT_BOOL = np.asarray([1] * NUM_LEGS)
LOWER_CONTACT_BOOL = np.asarray([0] * NUM_LEGS)
