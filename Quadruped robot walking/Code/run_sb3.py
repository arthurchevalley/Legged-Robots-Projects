...
number_timestep = 600000
env_configs = {"motor_control_mode": "CARTESIAN_PD",  # CARTESIAN_PD or TORQUE or PD
                "task_env": "ROBUST_OBSTACLES",  # FWD_LOCOMOTION or FWD_FALL or FWD_ENERGY_FALL or ROBUST_OBSTACLES or ROBUST_MATCH
                "observation_space_mode": "LR_ROBUST",  # DEFAULT or LR_BASE or LR_BASE_FEET or LR_ROBUST
...
if LOAD_NN:
    ...
    log_dir = interm_dir + model  # add path
...
model.learn(total_timesteps=number_timestep, log_interval=1,callback=checkpoint_callback)
